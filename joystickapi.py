# Code sourced from: https://stackoverflow.com/questions/60309652/how-to-get-usb-controller-gamepad-to-work-with-python
...
class JOYCAPS:
    ...
    def __init__(self, buffer):
        ...
        self.wXmin, self.wXmax, self.wYmin, self.wYmax, self.wZmin, self.wZmax, self.wNumButtons, self.wPeriodMin, self.wPeriodMax, self.wRmin, self.wRmax, self.wUmin, self.wUmax, self.wVmin, self.wVmax, self.wCaps, self.wMaxAxes, self.wNumAxes, self.wMaxButtons = uint_array
...
class JOYINFOEX:
    ...
    def __init__(self, buffer):
        ...
        self.dwSize, self.dwFlags, self.dwXpos, self.dwYpos, self.dwZpos, self.dwRpos, self.dwUpos, self.dwVpos, self.dwButtons, self.dwButtonNumber, self.dwPOV, self.dwReserved1, self.dwReserved2 = uint_array
